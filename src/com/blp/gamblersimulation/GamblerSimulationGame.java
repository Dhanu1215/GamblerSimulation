package com.blp.gamblersimulation;

/**
 * Gambler Simulation Game
 */
public class GamblerSimulationGame {
    ...
    private static void makeBet(int stake, int bet) {
        ...
        for (int months = 1; months <= 2; months++) {
            for (int noOfDays = 1; noOfDays <= 20; noOfDays++) {
                ...
                switch (choice) {
                    ...
                    case 1:
                        ...
                        count2++;
                        System.out.println("Number of times loose = " + count2);
                        break;
                }
            }
            ...
            System.out.println(("After each month Total loosing days = " + " " + (20-count) + " and Amount is = " + (money2 - money)));
        }
    }
}
